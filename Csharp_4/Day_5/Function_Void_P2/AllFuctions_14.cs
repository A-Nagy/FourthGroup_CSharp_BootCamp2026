...
namespace Csharp_4.Day_5.Function_Void_P2
{
     class AllFuctions_14
    {
        public static void EmployeeSalaryInfo()
        {
            Console.WriteLine("=================================");
        ...
        public static void StudentPercentageCalculator()
        {
            Console.WriteLine("=================================");
        ...
        public static void Patient_BMI_Calculator()
        {
            Console.WriteLine("=================================");
        ...
        public static void CountofDaysinMonths()
        {
            Console.WriteLine("=================================");
        ...
        public static void DiplayStrings()
        {
            Console.WriteLine();
