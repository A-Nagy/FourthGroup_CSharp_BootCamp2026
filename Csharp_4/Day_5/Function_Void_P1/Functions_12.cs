...
namespace Csharp_4.Day_5.Function_Void_P1
{
     class Functions_12
    {
        ...
        static void EmployeeSalaryInfo() 
        {
            Console.WriteLine("=================================");
        ...
        static void StudentPercentageCalculator() 
        {
            Console.WriteLine("=================================");
        ...
        static void Patient_BMI_Calculator() 
        {
            Console.WriteLine("=================================");
        ...
        static void CountofDaysinMonths() 
        {
            Console.WriteLine("=================================");
